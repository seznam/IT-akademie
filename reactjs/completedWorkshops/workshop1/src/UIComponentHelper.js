...
export default class UIComponentHelper {
	...
	getPercentOfVisibility(elmRect) {
		...
		let intersectionRects = this.getRectsIntersection(windowViewportRect, elmRect);
		let percent = (intersectionRects.width * intersectionRects.height) / (elmRect.width * elmRect.height) * 100;
